          ...
          {onStartMockInterview && matchScore !== null && matchScore !== undefined && (
            <div>
              <button
                ...
                aria-describedby={mockInterviewDisabledReason ? 'mock-interview-disabled-reason' : undefined}
              ...
              {mockInterviewDisabledReason && (
                <p id="mock-interview-disabled-reason" className="mt-2 text-xs text-amber-700">
                  {mockInterviewDisabledReason}
                </p>
              )}
            </div>
...
ResumePreview.propTypes = {
  ...
  mockInterviewDisabledReason: PropTypes.string,
